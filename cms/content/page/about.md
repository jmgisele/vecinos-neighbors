...
blocks:
  - _template: split
    ...
    body: >
      ...
      visitors see - no separate preview, no guesswork.


      Behind the scenes every change is a commit, so your content has the same
      history, branches, and review as the rest of your codebase.
    image:
  ...
  - _template: features
    ...
    items:
      - icon: code
        ...
        text: >
          Define your schema in TypeScript and wire up the editor exactly how
          you want it. TinaCMS bends to your stack, not the other way around.
      - icon: wand
        title: Editor-friendly
        text: >
          In-context visual editing means content creators see changes as they
          make them - no config files, no guesswork.
      - icon: lock-open
