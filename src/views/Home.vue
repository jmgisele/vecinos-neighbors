  ...
  <div class="home">
    ...
    <transition mode="out-in">
      ...
      <section v-else-if="activeTabValue === 'textareas'" class="tab textareas" key="textareas">
        ...
        <MbEditor v-model="editorTest" :dark="dark" label="This will output HTML" :max-len="200" output-format="html" />
        <MbEditor v-model="editorTest" :dark="dark" :formats="{ inline: ['em', 'strike'], block: false }" :format-options="{ allowNestedLists: false, minHeading: 2, maxHeading: 4 }" label="HTML with limited formats" output-format="html" />
