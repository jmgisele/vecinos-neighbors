<template lang="html">
  <TabContent class="schema-settings" :class="{ dark }" :dark="dark">
    <section class="wrapper wide">
      ...
      <MbFileList v-if="initialised" :action="createSchemaAction" :dark="dark" empty-state="There are no schemas in this folder" :file-actions="schemaActions" file-list-label="Schemas" pretty-filenames ref="fileList" :root="schemaDir" @fileclick="openSchema" @path-change="currentPath = $event" />
