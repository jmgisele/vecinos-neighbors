  ...
  <div class="components">
    ...
    <transition mode="out-in">
      ...
      <section v-else-if="activeTabValue === 'file-lists'" class="tab file-lists">
        ...
        <MbFileList :dark="dark" :file-actions="[{ action: previewFile, icon: 'folder-open', label: 'Open', filesOnly: true }, { disabled: true, icon: 'folder-open', label: 'Open', foldersOnly: true }, { action: moveEntity, icon: 'arrow-right', label: 'Move' }, { action: renameEntity, icon: 'text-input', label: 'Rename' }, { action: softDeleteFile, icon: 'trash', label: 'Delete', type: 'negative' }]" :folders-first="true" :folders-only="false" ref="fileList" root="/" show-hidden :action="{ callback: (path) => { currentPath = path; showEntityCreationModal = true; }, label: 'New', icon: 'plus', type: 'positive'}" @fileclick="previewFile" />
