...
export default [
  ...
  },
  {
    type: 'icon',
    default: null,
    description: 'A picker for choosing an icon from a folder of icons',
    group: 'content',
    icon: 'mattrbld',
    key: '',
    label: 'Icon',
    ...
    options: [
      ...
      },
      {
        ...
        key: 'insertAs',
        label: 'Insert as:',
        props: { inline: true, options: [{ label: 'File path', value: 'filepath' }, { label: 'URL Template', value: 'template' }] },
        value: 'filepath',
      },
      {
        component: 'MbInput',
        key: 'urlTemplate',
        label: 'URL template:',
        props: { placeholder: 'e.g. icons/:filename' },
        value: '',
      },
      {
        component: 'MbToggle',
        key: 'preserveColor',
        slot: 'Preserve icon color in previews',
        value: false,
      },
      {
        component: 'MbToggle',
        key: 'prettyFilenames',
        slot: 'Show only the icon file name in previews',
        value: false,
      },
      {
        component: 'MbToggle',
        key: 'removable',
        slot: 'Allow the icon to be removed once set',
        value: false,
      },
    ],
    tab: null,
