  ...
  <div class="file-picker" :class="{ dark }" tabindex="0" @click="activate" @keydown.space.prevent @keyup.space.enter="activate">
    ...
    <MbPopover center-x class="picker-popover" :dark="dark" no-content-padding ref="popover" :visible="showPicker" :x="popover.x" :y="popover.y" @close="deactivate">
      <div class="content-wrapper">
        <MbFileList :dark="dark" :empty-state="emptyState" :filetypes="filetypes" :filterable="false" :folders-first="mode === 'file' && foldersFirst" :folders-only="mode === 'folder'" ref="fileList" :root="root" :show-hidden="showHidden" :sortable="false" :style="{ width: `${listWidth}rem` }" @fileclick="pickEntity" />
